          ...
          <section className="min-h-screen">
              ...
              <div className="text-center p-10 py-10">
                  ...
                  <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
                        <a href="https://www.instagram.com/asrulcahyadi99/" target="_blank" rel="noopener noreferrer">
                            <AiFillInstagram/>
                        </a>
                          <a href="https://www.linkedin.com/in/asrul-cahyadi-putra/" target="_blank" rel="noopener noreferrer">
                              <AiFillLinkedin/>
                          </a>
                          <a href="https://github.com/asrulcahyadiputra" target="_blank" rel="noopener noreferrer">
                              <AiFillGithub/>
                          </a>
                  </div>
